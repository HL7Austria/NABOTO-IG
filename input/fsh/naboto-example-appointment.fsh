...
* extension[naboto-note][0].url = "http://fhir.naboto.com/StructureDefinition/naboto-note"
...
* extension[naboto-note][1].url = "http://fhir.naboto.com/StructureDefinition/naboto-note"
...
* participant[0].extension[VirtualServiceContactDetail].url = "http://fhir.naboto.com/StructureDefinition/virtual-service-contact-detail"
...
* participant[1].extension[VirtualServiceContactDetail].url = "http://fhir.naboto.com/StructureDefinition/virtual-service-contact-detail"
