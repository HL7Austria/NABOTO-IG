...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Patient">
      ...
      <sch:assert test="count(f:extension[@url = 'http://fhir.naboto.com/4.0.1/NabotoProfiles/StructureDefinition/at-core-ext-patient-religion']) &lt;= 0">extension with URL = 'http://fhir.naboto.com/4.0.1/NabotoProfiles/StructureDefinition/at-core-ext-patient-religion': maximum cardinality of 'extension' is 0</sch:assert>
  ...
  <sch:pattern>
    <sch:title>Patient.extension.extension.value[x].extension 1</sch:title>
  ...
  <sch:pattern>
    <sch:title>Patient.extension.extension.value[x].coding 1</sch:title>
    <sch:rule context="f:Patient/f:extension/f:extension/f:value[x]/f:coding">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>Patient.extension.extension.value[x].coding.extension 1</sch:title>
    <sch:rule context="f:Patient/f:extension/f:extension/f:value[x]/f:coding/f:extension">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children</sch:assert>
      <sch:assert test="exists(f:extension)!=exists(f:*[starts-with(local-name(.), &quot;value&quot;)])">Must have either extensions or value[x], not both</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>Patient.extension.extension.value[x].coding.system 1</sch:title>
    <sch:rule context="f:Patient/f:extension/f:extension/f:value[x]/f:coding/f:system">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>Patient.extension.extension.value[x].coding.version 1</sch:title>
    <sch:rule context="f:Patient/f:extension/f:extension/f:value[x]/f:coding/f:version">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>Patient.extension.extension.value[x].coding.code 1</sch:title>
    <sch:rule context="f:Patient/f:extension/f:extension/f:value[x]/f:coding/f:code">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>Patient.extension.extension.value[x].coding.display 1</sch:title>
    <sch:rule context="f:Patient/f:extension/f:extension/f:value[x]/f:coding/f:display">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>Patient.extension.extension.value[x].coding.userSelected 1</sch:title>
    <sch:rule context="f:Patient/f:extension/f:extension/f:value[x]/f:coding/f:userSelected">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>Patient.extension.extension.value[x].text 1</sch:title>
    <sch:rule context="f:Patient/f:extension/f:extension/f:value[x]/f:text">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
