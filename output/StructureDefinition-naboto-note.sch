...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Extension">
      <sch:assert test="count(f:extension[@url = 'note']) &gt;= 1">extension with URL = 'note': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'note']) &lt;= 1">extension with URL = 'note': maximum cardinality of 'extension' is 1</sch:assert>
